...
- PARTIAL `layouts/partials/article-link/simple.html`
- PARTIAL `layouts/partials/article-link/card.html`
- TODO `layouts/partials/article-link/card-related.html`
- TODO article meta partials (`article-meta/*`, `meta/*`)
- TODO article pagination / sharing / series
